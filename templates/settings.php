        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php _e( 'If the \'Name\' field is not selected or is empty, the email will appear to be from this name.', 'cef' ); ?></p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php _e( 'If the \'Email\' field is not selected or is empty, the email will appear to be from this email address.', 'cef' ); ?></p>
                </td>
            </tr>
            <tr>
